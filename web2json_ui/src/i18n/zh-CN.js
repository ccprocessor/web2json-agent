export default {
  ...
  parserTab: {
    ...
    autoMode: '自动模式',
    autoHint: 'AI 智能选取字段',
    autoModeHint: '点击下方按钮，AI将分析HTML并生成初步的字段定义，你可以预览并编辑这些字段',
    generateSchema: '生成初步Schema',
    generatingSchema: '正在生成Schema...',
    generatedFields: '生成的字段（可编辑）',
    regenerate: '重新生成',
    editFieldsHint: '你可以删除不需要的字段，或添加新字段',
