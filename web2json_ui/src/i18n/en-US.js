export default {
  ...
  parserTab: {
    ...
    autoModeHint: 'Click the button below. AI will analyze HTML and generate preliminary field definitions that you can preview and edit',
    generateSchema: 'Generate Preliminary Schema',
    generatingSchema: 'Generating Schema...',
    generatedFields: 'Generated Fields (Editable)',
    regenerate: 'Regenerate',
    editFieldsHint: 'You can remove unwanted fields or add new ones',
